...
>
> **Latest:** [Chapter 15 — The Sea and the Table](fabulas/cap15_o_mar_e_a_mesa.md) — the man goes to the sea on Saturday and sits at the table on Sunday; the mirror records a gap: zero events. And that is not a failure — silence is the owner living beyond the mirror's reach. A house that doesn't respect the owner's silence isn't intelligent — it's invasive
